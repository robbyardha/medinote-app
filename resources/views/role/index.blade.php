...
@section('content')
    ...
    @include('role.modal_add')
    @include('role.modal_edit')
    ...
    <script>
        $(document).ready(function() {
            $('#myTable').DataTable({
                ...
                processing: true,
                serverside: true,
                ajax: "{{ url('/access/role/getDataAjax') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'No',
                        orderable: true,
