...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            {{-- <select name="menu_id" id="menu-select"></select> --}}
    ...
    @include('submenu.modal_add')
    @include('submenu.modal_edit')
    ...
    <script>
        $(document).ready(function() {
            $('#myTable').DataTable({
                ...
                processing: true,
                serverside: true,
                ajax: "{{ url('/access/submenu/getDataAjax') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'No',
                        orderable: true,
            ...
            $('body').on('click', '.btn-show-modal-edit', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: `/access/submenu/edit/${id}`,

                    success: function(response) {

                        $('#menu_id_edit').val(response.result.menu_id);
